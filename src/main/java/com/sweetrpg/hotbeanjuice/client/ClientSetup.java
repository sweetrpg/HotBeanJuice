...
public class ClientSetup {
    ...
    public static void setupScreenManagers(final FMLClientSetupEvent event) {
        ...
        ItemBlockRenderTypes.setRenderLayer(ModBlocks.DRIP_COFFEE_CARAFE.get(), RenderType.translucent());
        ItemBlockRenderTypes.setRenderLayer(ModBlocks.DRIP_COFFEE_MACHINE.get(), RenderType.cutout());
        ItemBlockRenderTypes.setRenderLayer(ModBlocks.FRENCH_PRESS.get(), RenderType.translucent());
        ItemBlockRenderTypes.setRenderLayer(ModBlocks.PERCOLATOR.get(), RenderType.cutout());
