...
//
//@OnlyIn(Dist.CLIENT)
//public class PodMachineScreen extends AbstractContainerScreen<PodMachineMenu> {
...
//
//    public PodMachineScreen(PodMachineMenu menu, Inventory playerInventory, Component title) {
