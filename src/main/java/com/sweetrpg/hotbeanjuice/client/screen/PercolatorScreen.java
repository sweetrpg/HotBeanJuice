...
@OnlyIn(Dist.CLIENT)
public class PercolatorScreen extends AbstractContainerScreen<PercolatorMenu> {
    ...
    public PercolatorScreen(PercolatorMenu menu, Inventory playerInventory, Component title) {
