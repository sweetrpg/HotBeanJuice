...
//import com.sweetrpg.hotbeanjuice.common.inventory.menus.KettleMenu;
...
//    private static final ResourceLocation TEXTURE = new ResourceLocation(Constants.MOD_ID, "textures/gui/kettle.png");
//    private List<Component> tooltip = Lists.newArrayList();
//
//    public KettleScreen(KettleMenu menu, Inventory playerInventory, Component title) {
