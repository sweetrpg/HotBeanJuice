...
@OnlyIn(Dist.CLIENT)
public class DripCoffeeMenu extends AbstractContainerMenu {
    ...
    public DripCoffeeMenu(int containerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.DRIP_COFFEE_MENU.get(), containerId);
        ...
        this.blockEntity.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY).ifPresent(handler -> {
            this.addSlot(new SlotItemHandler(handler, 0, 31, 31));
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.DRIP_COFFEE_MAKER.get());
    }
