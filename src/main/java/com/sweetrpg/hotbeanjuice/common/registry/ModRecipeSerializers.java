...
public class ModRecipeSerializers {
    ...
    public static final RegistryObject<RecipeSerializer<GrindingRecipe>> GRINDING_SERIALIZER = RECIPE_SERIALIZERS.register("grinding", () -> GrindingRecipe.Serializer.INSTANCE);
