...
//
//public class CampfirePotBlockEntity extends PlacedBlockEntity {
//
//    public CampfirePotBlockEntity(BlockPos pos, BlockState blockState) {
//        super(ModBlockEntityTypes.CAMPFIRE_POT_BLOCK_ENTITY.get(), pos, blockState);
//    }
//
