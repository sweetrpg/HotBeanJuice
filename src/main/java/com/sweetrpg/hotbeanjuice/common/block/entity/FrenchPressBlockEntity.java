...
public class FrenchPressBlockEntity extends PlacedBlockEntity {

    public FrenchPressBlockEntity(BlockPos pos, BlockState blockState) {
        super(ModBlockEntityTypes.FRENCH_PRESS_BLOCK_ENTITY.get(), pos, blockState);
    }
