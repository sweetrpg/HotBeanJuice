...
public class Constants {
    ...
    public static final String TRANSLATION_KEY_BLOCK_POWERED_COFFEE_GRINDER_TITLE = "block.hotbeanjuice.powered_coffee_grinder";
    public static final String TRANSLATION_KEY_BLOCK_TRAVEL_CUP_TITLE = "block.hotbeanjuice.travel_cup";
